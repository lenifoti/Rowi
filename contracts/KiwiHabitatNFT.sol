...
contract KiwiHabitat is ERC721, ERC721URIStorage, ERC721Enumerable,  Pausable, Ownable, ERC721Burnable {
...
/*
    ...
    {
        require( balanceOf(msg.sender) <=2, "Sorry, only 2 per account." );
        //require( totalSupply() < totalHabitatSupply, "Sorry only 5 are available at this time. ");
        //_tokenIds.increment();
